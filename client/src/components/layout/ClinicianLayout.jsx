        ...
        <div className="app-container">
            ...
            <main className="main-content">
                <div className="mobile-toggle">
                    <div style={{ fontWeight: 700, fontSize: 18 }}>MindFlow Pro</div>
                ...
                <header style={{ marginBottom: 32, display: "flex", justifyContent: "space-between", alignItems: "center", paddingBottom: 24, borderBottom: "1px solid var(--glass-border)" }}>
                    ...
                    <div style={{ display: "flex", gap: 12 }}>
                        <div style={{ width: 42, height: 42, borderRadius: "50%", background: "var(--secondary)", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 700, color: "#000" }}>
                            Dr
                        </div>
                    </div>
                </header>
